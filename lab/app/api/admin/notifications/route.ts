...
import { createNotificationChannel, listNotificationChannels, NOTIFICATION_EVENTS } from "@/lib/server/notifications";
...
export async function GET() {
  try {
    ...
    return NextResponse.json({ channels: await listNotificationChannels(), events: NOTIFICATION_EVENTS });
  } catch (error) {
